...
helpMessage ="""•÷Ψṳ̤̈̈Ҝḧ̤̤̈ï̤̤̈Σ s̤̤̈̈Σl̤̤̈̈Ғ Δṳ̤̈̈ẗ̤̤̈ḧ̤̤̈Ωr̤̤̈̈÷
...
admsa = "u8996c744f260a1bb693578eb00ab52c4"
admin = "uadfd85841b5f18645653d4cfaf375bc0"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "uadfd85841b5f18645653d4cfaf375bc0":
                    if "join:" in msg.text:
...
#-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Anakjin","Tagall"]:
                  group = cl.getGroup(msg.to)
                  ...
                  try:
                      cl.sendText(msg.to,"Bang Bang Bang..👈")
                      cl.sendMessage(msg)
...
#--------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                if wait["clock"] == True:
                    ...
                    wait["clock"] = True
                    now2 = datetime.now()
                    nowT = datetime.strftime(now2,"x%H:%M ��☄")
                    profile = cl.getProfile()
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Checking Sider..(｀・ω・´)")
                try:
                ...
                wait2['setTime'][msg.to] = datetime.strftime(now2,"x%H:%M ��☄")
                wait2['ROM'][msg.to] = {}
                print wait2
            elif msg.text == "View":
              if msg.from_ in admin:
		  if msg.to in wait2['readPoint']:
	            if wait2["ROM"][msg.to].items() == []:
	              ...
	              for rom in wait2["ROM"][msg.to].items():
	                print rom
	                chiya += rom[1] + "\n"
	            cl.sendText(msg.to, "====== SIDER LIST ====== (｀・ω・´)")
	            cl.sendText(msg.to, "%s\n\n\n[ People who have ignored reads ]\n\n%s\n\nCheck lastseen point(｀・ω・´)[ %s ]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
	          else:
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                           try:
                               ...
                               cl.sendText(msg.to,"Success MengCopy")
                    ...
                    try:
                       ...
                       cl.sendText(msg.to, "Telah kembali semula Semua")
                    except Exception as e:
...
#-----------------------------------------------
            elif msg.text in ["Maju jalan","Kuy"]:
...
#			    random.choice(KAK).kickoutFromGroup(op.param1,[op.param2])
	...
	if op.type == 11:
        ...
        if op.type == 15:
            random.choice(KAC).sendText(op.param1, cl.getContact(op.param2).displayName + " Selamat Tinggal..😘")
     ...
     for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
          try:    
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"'I Like Your Post.'")
            ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1003)
